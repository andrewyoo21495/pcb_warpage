...
<div class="container">
    ...
    <div class="header">
        <h1>PCB Warpage 특성 변수 설명서</h1>
        <p>공정 상관분석을 위해 선정된 12개 핵심 변수의 정의, 수식, 시각적 예시를 정리한 문서입니다.<br>
    ...
    <div class="toc">
        ...
        <ol>
            <li><a href="#overview">개요 — PCB Warpage 데이터란?</a></li>
            <li><a href="#basic-stats">기본 통계량 (3개 변수)</a></li>
    ...
    <div class="section" id="overview">
        ...
        <div class="info-box success">
            <strong>선정된 변수 카테고리 (총 12개)</strong>
            <ul style="margin-top:8px; padding-left:20px;">
                <li><span class="category-tag cat-basic">기본 통계</span> max_warpage, skewness, kurtosis (3개)</li>
    ...
    <!-- ================================================================== -->
    <div class="section" id="basic-stats">
        <h2><span class="step-badge">2</span> 기본 통계량 <span class="category-tag cat-basic">3개 변수</span></h2>
        <p>warpage surface의 전체적인 크기와 분포 형태를 수치로 요약하는 핵심 변수들입니다.
        계산이 간단하고 해석이 직관적이어서 공정 상관분석의 첫 번째 단계로 적합합니다.</p>
    ...
    <div class="section" id="summary">
        ...
        <p>추출되는 12개 변수의 전체 목록입니다. Excel 출력 시 이 순서대로 열이 생성됩니다.</p>
        ...
        <table>
            ...
            <tr><td>4</td><td><span class="category-tag cat-mode">형상 분류</span></td>
                <td><code>center_vs_edge_ratio</code></td><td>연속</td><td>중심/가장자리 비율</td><td>center_vs_edge_ratio</td></tr>
            <tr><td>5</td><td><span class="category-tag cat-mode">형상 분류</span></td>
                <td><code>saddle_index</code></td><td>연속</td><td>안장 형상 지수</td><td>saddle_index</td></tr>
            <tr><td>6</td><td><span class="category-tag cat-mode">형상 분류</span></td>
            ...
            <tr><td>9</td><td><span class="category-tag cat-geometry">표면 형상</span></td>
                <td><code>mean_gradient</code></td><td>연속</td><td>평균 기울기</td><td>mean_gradient</td></tr>
            <tr><td>10</td><td><span class="category-tag cat-geometry">표면 형상</span></td>
                <td><code>max_gradient</code></td><td>연속</td><td>최대 기울기</td><td>max_gradient</td></tr>
            <tr><td>11</td><td><span class="category-tag cat-geometry">표면 형상</span></td>
    ...
    <div class="section" id="usage">
        ...
        <p><code>wap_parameter_extract.py</code>를 사용하여 전처리 완료된 .txt 파일에서 위 12개 변수를 자동 추출하고
        Excel 파일로 저장합니다.</p>
        ...
        <p style="margin-top:8px;">
            ...
            이후 12개 열이 각 변수 값입니다. 카테고리별로 헤더 행이 색상으로 구분됩니다.
        </p>
    </div>
